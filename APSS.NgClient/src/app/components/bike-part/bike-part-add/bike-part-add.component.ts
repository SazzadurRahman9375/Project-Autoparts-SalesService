...
@Component({
  selector: 'app-bike-part-add',
  templateUrl: './bike-part-add.component.html',
  styleUrl: './bike-part-add.component.css'
})
export class BikePartAddComponent implements OnInit{
  ...
  */
  ...
  saveImages(){
    ...
    ngOnInit(): void {
      ...
      this.productService.getCategoriesOf(2)
      .subscribe({
        next: r=>{
