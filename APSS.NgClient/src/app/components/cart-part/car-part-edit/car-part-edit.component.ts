...
@Component({
  selector: 'app-car-part-edit',
  templateUrl: './car-part-edit.component.html',
  styleUrl: './car-part-edit.component.css',
})
export class CarPartEditComponent implements OnInit {
  ...
  */
  ...
  ngOnInit(): void {
    ...
    this.productService.getCategoriesOf(1).subscribe({
      next: (r) => {
