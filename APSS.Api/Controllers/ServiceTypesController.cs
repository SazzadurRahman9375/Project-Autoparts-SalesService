...
namespace APSS.Api.Controllers
{
    ...
    public class ServiceTypesController : ControllerBase
    {
        ...
        public ServiceTypesController(AutoPartsDbContext context)
        {
            _context = context;
        }
        ...
        [HttpGet("Of/{id}")]
        public async Task<ActionResult<IEnumerable<ServiceType>>> GetServiceTypeOfType(int id)
        {
            var serviceTypes = await _context.ServiceTypes.Where(c => c.VehicleTypeId == id).ToListAsync();
